...
import { Box, Button, Container, FormControl, Grid, InputAdornment, LinearProgress, Pagination, Tab, Tabs, TextField, Typography } from "@mui/material";
                ...
                <Container maxWidth="xl"  >
                    ...
                    <Box mt={4} mb={3} sx={{ borderBottom: 1, borderColor: 'divider' }}>
                        <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
                            <Tab label={ <Typography variant="h6"> Nutrition Facts </Typography>} {...a11yProps(0)} />
                            <Tab label={<Typography variant="h6"> Certification </Typography>} {...a11yProps(1)} />
                            <Tab label={<Typography variant="h6"> Helping Hands </Typography>} {...a11yProps(2)} />
                        </Tabs>
                    </Box>
                    <Box>
                                ...
                                <Grid item md={7} sx={{borderLeft:"1px solid lightgray"}} alignItems={"center"} >
                                    <Box ml={2} display={"flex"} justifyContent={"flex-start"} >
                                        ...
                                        <Box ml={3} display={"flex"} alignItems={"center"} >
                                            <LinearProgress sx={{width:"300px"}} variant="determinate" value={90} valueBuffer={10} />
                                            </Box>
                                    </Box>
                                    <Box ml={2} display={"flex"} justifyContent={"flex-start"} >
